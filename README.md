...
После нажатия на кнопку **Создать**, указанный предмет с выбранными шаблонами будет создан, а в отдельном меню будут выведены полученные им свойства.

<p align="center"><img width="400" height="600" alt="Итоговое меню" src="https://github.com/user-attachments/assets/e07cb423-9586-4de0-b9f1-2ca758d0f394"/></p>
...
- Мародёрство. Уменьшать стоимость предметов: если включено, стоимость денежной награды при быстрой продаже будет уменьшена вдвое, после применения "Мародёрство. Модификатора стоимости добычи".
...
- Генератор. Скрывать Скрипты Генератора: eсли включено, Скрипты Генератора предметов в готовых предметах не будут видны игрокам.
...
After clicking the **Create** button, the specified item with the selected templates will be created, and its properties will be displayed in a separate menu.

<p align="center"><img width="400" height="600" alt="Summary menu" src="https://github.com/user-attachments/assets/e07cb423-9586-4de0-b9f1-2ca758d0f394"/></p>
...
- Generator. Hide Generator Scripts: if enabled, the Item Generator Scripts in the finished items will not be visible to the players.
