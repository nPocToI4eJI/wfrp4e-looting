...
- **Статус автоматизации**: _полная._
...
- **Триггер**: _проверки Наблюдательности или Дальнего боя (и основанных на нём навыков) против цели, носящей эти одеяния._
- **Цель**: _сам._
...
- **Статус автоматизации**: _частичная._
...
- **Статус автоматизации**: _полная / частичная._
